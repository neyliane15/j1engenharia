...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        card: '0 1px 2px 0 hsl(175 40% 12% / 0.04), 0 1px 3px 1px hsl(175 40% 12% / 0.04)',
        raised: '0 4px 12px -2px hsl(175 40% 12% / 0.10), 0 2px 4px -2px hsl(175 40% 12% / 0.06)',
        pop: '0 12px 32px -8px hsl(175 40% 12% / 0.18)',
      },
      keyframes: {
